...
#define GDT_FLAGS_LOWER_DPL2    0x50
...
#define GDT_FLAGS_LOWER_TSS         (GDT_FLAGS_LOWER_DPL1 | GDT_FLAGS_LOWER_P)
...
// 기타 GDT에 관련된 매크로
// GDTR의 시작 어드레스, 1MBtj 268KB까지는 페이지 테이블 영역
...
/* 선형주소로부터 페이지 테이블 엔트리를 참조하기 위한 매크로 */
#define MASK_PML4           0xFF8000000000
#define MASK_PDP            0x7FC0000000
#define MASK_PD             0x3FE00000
#define MASK_PT             0x1FF000
#define SHIFT_PML4          0x8000000000
#define SHIFT_PDP           0x40000000
#define SHIFT_PD            0x200000
#define SHIFT_PT            0x1000
#define MASK_BASE        0xFFFFFFF000
#define SHIFT_BASE          0xC
