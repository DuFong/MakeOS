...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
START:
    mov ax, 0x1020  ; 보호 모드 엔트리 포인트의 시작 어드레스(0x10200)를 
                    ; 세그먼트 레지스터 값으로 변환
...
PROTECTEDMODE:
    ...
    push ( SWITCHSUCCESSMESSAGE - $$ + 0x10200 )    ; 출력할 메시지의 어드레스르 스택에 삽입
    push 2                                          ; 화면 Y 좌표(2)를 스택에 삽입
    push 0                                          ; 화면 X 좌표(0)를 스택에 삽입
    call PRINTMESSAGE                               ; PRINTMESSAGE 함수 호출
    add esp, 12                                     ; 삽입한 파라미터 제거

    jmp dword 0x08: 0x10400 ; C 언어 커널이 존재하는 0x10400 어드레스로 이동하여 C 언어 커널 수행
...
GDTR:
    ...
    dd ( GDT - $$ + 0x10200 )   ; 아래에 위치하는 GDT 테이블의 시작 어드레스
